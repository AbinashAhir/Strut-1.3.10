...
public class UpdateStudentAction2 extends Action {
	@Override
...
//	String type = request.getParameter("std_type");
		...
		System.out.println("Id : " + stdForm.getStd_id() + " name : " + stdForm.getStd_name() + " type : "
				+ stdForm.getStd_type() + " age: " + stdForm.getStd_age());
		...
		return mapping.findForward("update2");
	}
}
