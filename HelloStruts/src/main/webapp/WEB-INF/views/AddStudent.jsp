...
<body>
	<div class="wrapper">
		<div class="header">
			<h1>Welcome to Our Beautiful Struts Add Student Page</h1>
		</div>

		<h2>Add the Student details.</h2>

		<form action="/HelloStruts/saveStudent.do" method="post">
		...
		<div class="footer">
			<p>&copy; 2023 Beautiful Add Student Page. All rights reserved. Made with Love by
				@Abinash Ahir.</p>
		</div>
	</div>
</body>
